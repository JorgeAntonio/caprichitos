...
<template>
    <footer class="footer p-10 bg-neutral text-neutral-content">
        <div>
            <h1 class="font-semibold text-xl">Dulce Caprico</h1>
        ...
        <div>
            ...
            <div class="grid grid-flow-col gap-4">
                <a href="https://www.tiktok.com/@caprichos011?_t=8eecnbZ52YQ&_r=1" class="hover:opacity-60">
                ...
                <a href="https://www.facebook.com/profile.php?id=100091205517409" class="hover:opacity-60">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="32" viewBox="0 0 448 512">
                        <path fill="currentColor"
                ...
                <a href="https://sites.google.com/view/dulcecaprichoiquitos/nosotros" class="hover:opacity-60">
